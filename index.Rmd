...
<q> **找出女孩們最常PO文的時間！** </q>
```{r,echo=FALSE,fig.width=13.6,fig.height=8}
library(ggplot2)
load('girltime.RData')
...
ggplot(data=girlhour,aes(x=time,y=counts))+geom_bar(stat='identity',aes(fill=counts))+scale_fill_gradient(low='yellow',high='red')+theme(text=element_text(size=30),plot.title=element_text(size=50,face='bold',family='sans'))+ggtitle('ggplot2')
```
